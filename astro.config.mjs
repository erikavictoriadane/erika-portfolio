...
export default defineConfig({
  ...
  site: process.env.SITE_URL || (isCustomDomain ? 'https://example.com' : `https://${githubOwner}.github.io`),
  base: process.env.BASE_PATH || (isGitHubActions && !isCustomDomain ? `/${githubRepo}` : '/'),
